...
int main() {
    Produk produk[] = {
        ...
        {"P006", "Ayam", 35000, 0},
        {"P007", "Salmon", 85000, 0},
        {"P008", "Tongkol", 29000, 0},
        {"P009", "SusuSapi", 12500, 0},
        {"P010", "SusuKambing", 15000, 0},
        {"P011", "Beras", 160000, 0},
        {"P012", "Pasta", 4500, 0},
        {"P013", "Mie", 3500, 0},
        {"P014", "Minyak", 22000, 0},
        {"P015", "Tepung", 12000, 0},
        {"P016", "Keripik", 8000, 0},
        {"P017", "Biskuit", 15000, 0},
        {"P018", "Permen", 750, 0},
        {"P019", "Coklat", 12500, 0},
        {"P020", "Tomat", 15000, 0},
        {"P021", "DagingKaleng", 50000, 0},
        {"P022", "Soda", 7500, 0},
        {"P023", "Teh", 1500, 0},
        {"P024", "Kopi", 1000, 0},
        {"P025", "Wajan", 125000, 0},
        ...
        {"P033", "Pemutih", 750, 0},
        {"P034", "Pengharum", 15000, 0},
        {"P035", "Sabun", 3500, 0},
        {"P036", "Sampo", 12500, 0},
        {"P037", "SikatGigi", 15000, 0},
        {"P038", "PastaGigi", 75000, 0},
        {"P039", "Handuk", 12500, 0},
        {"P040", "Lampu", 15000, 0},
        {"P041", "Baterai", 16000, 0},
        {"P042", "KabelIsi", 30000, 0},
        {"P043", "Kaos", 10000, 0},
        {"P044", "PakaianDalam", 10000, 0},
        {"P045", "Kaus Kaki", 5000, 0},
        {"P046", "Deodoran", 6000, 0},
        {"P047", "LemariEs", 3000000, 0},
        {"P048", "AC", 2500000, 0},
        {"P049", "Oven", 1250000, 0},
        {"P050", "Kompor", 150000, 0},
        {"P051", "Televisi", 1670000, 0},
        {"P052", "Mainan", 50000, 0},
        {"P053", "SusuBayi", 70000, 0},
        {"P054", "MakananBayi", 30000, 0},
        ...
        {"P062", "Perban", 8000, 0},
        {"P063", "Obat", 10000, 0},
        {"P064", "MakananKucing", 25000, 0},
        {"P065", "MakananAnjing", 30000, 0},
        {"P066", "MakananKecoa", 10000, 0},
        {"P067", "Bir", 20000, 0},
        {"P068", "Rokok", 25000, 0},
        {"P069", "Suplemen", 45000, 0},
        {"P070", "ObatHerbal", 35000, 0},
    };
